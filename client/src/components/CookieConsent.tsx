...
export default function CookieConsent() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-50">
      ...
      <div className={`mx-auto max-w-2xl rounded-t-2xl md:rounded-2xl shadow-2xl border border-white/20 bg-gray-900/95 backdrop-blur-xl m-4 ${open ? 'md:fixed md:inset-0 md:max-w-xl md:m-auto md:translate-x-[-50%] md:translate-y-[-50%] md:left-[50%] md:top-[80%] md:h-fit' : ''}`}>
        <div className="p-7">
